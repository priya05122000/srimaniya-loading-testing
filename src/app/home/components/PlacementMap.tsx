...
const FlagPin: React.FC<Flag> = ({ img, placement, ctc, position, size }) => (
  <div className={`absolute ${position} flex flex-col items-start z-20`}>
    <div className="relative group cursor-pointer">
      <div
        className={`${size} rounded-full overflow-hidden  shadow-lg flex items-center justify-center bg-(--white-custom)`}
      >
        <Image
          src={img}
          alt={placement + " Flag"}
      ...
      <Paragraph className="absolute top-10 left-1/2 -translate-x-1/2 mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-(--blue) text-(--white-custom) px-5 py-3 shadow min-w-[200px] text-start font-bold border-(--yellow-custom) border pointer-events-none">
      ...
      <div className="block sm:hidden">
        <motion.div className="relative z-10 w-full h-full flex flex-col justify-center p-6">
          <div className="relative z-10 ">
            ...
            >
              Every pin on this map is a destination of our talented students.
              Each flag represents a renowned global partner where our graduates
              launch distinguished careers.
            </Paragraph>
          </div>
        </motion.div>
      </div>
          ...
          <div className="absolute top-0 left-0 h-full w-[40%] items-center hidden sm:flex">
            <motion.div className="relative z-10 h-full flex flex-col justify-center p-6">
              ...
              <div className="relative z-10 pl-6 sm:pl-8">
                ...
                >
                  Every pin on this map is a destination of our talented
                  students. Each flag represents a renowned global partner where
                  our graduates launch distinguished careers.
                </Paragraph>
              </div>
            </motion.div>
          </div>
