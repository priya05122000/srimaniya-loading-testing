            ...
            <div className="flex flex-col sm:flex-row justify-between">
              ...
              <div className="w-full sm:w-sm">
                ...
                <Span className="text-white-custom">
                  Sri Maniya Institutions offer a dedicated learning atmosphere rooted in a strong heritage of hospitality excellence. Their success stems from committed faculty and driven students, creating an environment that fosters professional growth and industry readiness.
                </Span>
              </div>
