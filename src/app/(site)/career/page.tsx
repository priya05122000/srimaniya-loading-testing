...
export const metadata: Metadata = {
  ...
  title: "Hospitality Jobs at Sri Maniya, Tamil Nadu",
  description:
    "Want to shape future hoteliers? Sri Maniya Institute is hiring passionate faculty & hospitality professionals. Apply now!",
  keywords: [
