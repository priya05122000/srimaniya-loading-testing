...
const HeroSwiper = dynamic(() => import("./HeroSwiper"), { ssr: false, loading: () => null });

const HeroPlaceholder = ({ banner }: { banner: Banner }) => (
  <div
...
const HeroClient = ({ banners }: { banners: Banner[] }) => {
  ...
  return (
    <>
      ...
      {!swiperReady && <HeroPlaceholder banner={banners[0]} />}
      <HeroSwiper banners={banners} onReady={() => setSwiperReady(true)} />
    </>
  );
};
